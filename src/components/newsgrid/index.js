 ...
 * News Card Small
 *
 * This is news card small size variant
 *
 */
...
const NewsGrid = (props) => {
  return (
    <>
      <Card
        className="news-card news-grid"
        title={
          props.title ? (
            <div className="align-text-left">
              {props.titleLogo ? (
                <div>
                  <img width={"50%"} src={props.titleLogo} alt={"123"} />{" "}
                </div>
              ) : (
                <></>
              )}{" "}
      ...
      >
        <div className="align-text-left">
          {props.description ? updateTextLenght(props.description, 200) : <></>}
          {props.metaTitle ? (
            <Card.Meta
              title={
                <div>
                  ...
                  {updateTextLenght(props.metaTitle, 75)}
                </div>
              }
              description={
